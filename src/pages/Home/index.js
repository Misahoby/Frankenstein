...
const Home = () => {
  return (
    <React.Fragment>
      <div className="row mx-0 d-flex align-items-center home-grp-img">
        <div className="col-md-6 text-center my-3">
          <img
            src="/images/head/head.png"
            alt="head-left"
            className="head-img"
          />
        </div>
        <div className="col-md-6 my-3">
          ...
          />
          <p className="font-family-com">
            Our mission is to provide everyday crypto investors access to{" "}
            <span className="p-text">the best NFT projects</span> without having
            to spend the time and intensive capital to do so.
          </p>
        </div>
      </div>
      <div className="row mx-0 mt-5 d-flex align-items-center">
        ...
        <div className="col-md-6 my-3 d-flex justify-content-center">
          <div>
            <h1 className="my-4 font-home font-home-size">
              10% Buy and Sell Tax
            </h1>
            <div className="d-flex align-items-center my-3 mx-2">
              <img src="/images/home/head1.svg" alt="head1" />
      ...
      <div className="mt-5 d-flex justify-content-center">
        <div className="hands-text">
          <div className="hands-text-style d-flex justify-content-center">
            <h1 className="hands-text-box font-home">
              Our Treasury invests in blue-chip and up-and-coming NFTs across
              all sectors.
            </h1>
          </div>
          <div className="text-center mt-2">
            <p className="hands-text-p mb-0 font-home">
              - 60% of investments are voted by the community
            </p>
            <p className="hands-text-p mb-4 font-home">
      ...
      <div className="row mx-0 mt-5 d-flex align-items-center">
        <div className="col-md-6 text-center">
          <h2 className="font-home my-3 font-home-size">
